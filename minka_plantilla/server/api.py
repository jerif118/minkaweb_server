...
def make_app():
    return tornado.web.Application([
        (r"/api/rooms", CreateRoomHandler),       # POST: crear sala
        (r"/api/rooms/join", JoinRoomHandler),    # POST: unirse a sala
        (r"/api/rooms/leave", LeaveRoomHandler),  # POST: salir de sala
        (r"/api/rooms/message", SendMessageHandler), # POST para enviar mensaje
        (r"/api/rooms_all", ListRoomsHandler),        # GET: listar salas
    ])
